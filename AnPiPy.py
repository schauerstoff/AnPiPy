...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # new
        self.Copy1.clicked.connect(self.fill_images)
    ...
    def copyClipTest(self):
        self.send_to_clipboard('captcha.png')
...
class Data:
    ...
    def download_images(self, driver, word):
...
class Main:
    ...
    # trying to get all the seperated stuff to work together here
    def setup(self):
        self.chrome.setup_chrome()
        self.data.setup_data()
        # test
        self.data.download_images(self.chrome.driver, "日本")


# Execute, ka warum UI nicht in Main will
